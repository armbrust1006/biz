...
public class UserController {
	...
	@Autowired
	MemberRepository mRPS;
	@Autowired
	CardImageRepository cardIMG_RPS;
	...
	public String login(Member member, HttpSession session, Model model) {
		Member selectM = mRPS.selectM(member);
		if (selectM != null) {
	...
	public String emailcheck(String email, Model model) {
		Member result = mRPS.emailCheck(email);
