...
public class AuthMail {   // 클래스 이름이랑 생성자 이름 맞추면 됩니당

      private String user; // 받을 사람
      private String title; //제목
      private String message;//내용

      public AuthMail(String user,String title,String message) {
         this.user = user;
      ...
      public int test(String user)
      {
         ...
         String title = "[인증메일] 인증 번호";
         String message = "인증번호 : " + accreditation;
         new AuthMail(user, title, message);
