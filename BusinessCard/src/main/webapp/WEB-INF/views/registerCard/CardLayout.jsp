		...
		if (layout_num == 2) {
			...
			if (file != null) {
				reader.addEventListener("load", function() {
					var img = new Image();
					img.onload = function() {
						context.drawImage(img, 400, 50, img.width/(1.5), img.height/(1.5));
					}
					img.src = reader.result;
				}, false);
			...
			context.fillText(document.getElementById("mobile").value, 70, 200);
			context.fillText(document.getElementById("telephone").value, 70, 220);
			context.fillText(document.getElementById("fax").value, 70, 240);
			context.fillText(document.getElementById("email").value, 70, 260);
		}//5번 if
