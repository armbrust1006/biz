          ...
          <div class="cell-md-8 cell-lg-9">
            <article class="post post-single">
              <div class="post-image">
                <figure><img src="images/870x412.jpg" alt="" width="870" height="412"/> </figure>
              </div>
              <div class="post-header">
                <h4>5 Simple Steps to Blogs Success</h4>
              </div>
              <div class="post-meta">
                ...
                <div class="comment-group">
                  <article class="comment">
                    <div class="unit unit-spacing-md unit-xs-horizontal">
                      <div class="unit-left">
                        <figure><img src="images/70x71.jpg" alt="" width="70" height="71"/> </figure>
                      </div>
                      <div class="unit-body">
                    ...
                    <div class="unit unit-spacing-md unit-xs-horizontal">
                      ...
                      <div class="unit-body">
                        <div class="comment-body">
                          ...
                          <div class="comment-body-text">
                            <p>Very useful post! Thanks for sharing! Now Ill be planning my visit to your gym to take part in some fitness classes.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="inset-md-left-15 inset-md-right-10">
              <div class="range">
                <div class="cell-sm-6 cell-md-12">
                  <form action="search-results.html" method="GET" class="rd-search rd-search-classic">
                    <div class="form-group">
                  ...
                  <div class="offset-top-50">
                    ...
                    <ul class="list-marked-bordered offset-top-15">
                      <li><a href="#"><span>Marketing</span><span class="text-dusty-gray">(4)</span></a></li>
                      <li><a href="#"><span>Events</span><span class="text-dusty-gray">(4)</span></a></li>
                      <li><a href="#"><span>Design</span><span class="text-dusty-gray">(4)</span></a></li>
                    </ul>
                  </div>
                  <div class="offset-top-50">
                    ...
                    <div class="offset-top-30">
                      <article class="post post-preview offset-top-15"><a href="blog-post.html">
                        <div class="unit unit-horizontal unit-spacing-sm">
                          <div class="unit-left">
                            <figure class="post-image"><img src="images/70x70.jpg" alt="" width="70" height="70"/> </figure>
                          </div>
                          <div class="unit-body">
                            <div class="post-header">
