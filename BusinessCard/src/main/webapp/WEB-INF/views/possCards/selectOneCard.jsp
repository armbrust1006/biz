				...
				<form>
					<div class="modal-body">
						<div class="cell-xs-4 offset-top-30 offset-xs-top-30 offset-sm-top-50">
							...
							<div class="form-group">
								<textarea name="content" id="content" data-constraints="@Required" class="form-control"></textarea>
								<label for="content" class="form-label" >Message
								</label>
							</div>
						</div>
						<!-- cell 끝 -->
						...
						<div class="product product-single">
							<div class="product-main">
								...
								<div class="product-body">
									...
									<input type="text" id="selectedName" name="selectedName" value="${selectedCard.name}" readonly />
									<input type="text" id="selectedPosition" name="selectedPosition" value="${selectedCard.position}" readonly />
