							...
							<div class="product-main">
								...
								<div class="product-body">
									...
									<h4 class="product-header">
										...
										<c:if test="${searchCard ne 'searchCard'}">
											<button type="button" class="button"
									...
									<div id="accordionOne" role="tablist"
										...
										<c:choose>
											<c:when test="${searchCard eq 'searchCard'}">
												<div class="btn btn-primary-outline btn-shadow" id="cardAdd">Put My List</div>
											</c:when>
											<c:otherwise>
												<div class="btn btn-primary-outline btn-shadow"
													...
													<form id="cardDeleteForm" method="POST" action="cardDelete">
														<input type="hidden" id="cardNum" name="cardNum"
															...
															type="hidden" id="cardType" name="cardType"
															value="others">
													</form>
												</div>
											</c:otherwise>
