...
<script type="text/javascript">
	...
	function cardView() {
		...
		context.fillText("James Cloud" + document.getElementById("name").value, 270, 70);
		
		context.font = "20px Arial";
		context.fillText("Komorebi Co" + document.getElementById("company").value, 200, 130);
		
		context.font = "15px Arial";
		context.fillText("영업부" + document.getElementById("depart").value, 200, 60);
		context.fillText("부장 " + document.getElementById("position").value, 200, 80);
		
		
		context.font = "15px Arial";
		context.fillText("서울시 강남구 삼성동 코엑스 4층 101호" + document.getElementById("address").value, 200, 180);
		context.fillText("Mobile | 010-4013-1414" + document.getElementById("mobile").value, 200, 200);
		context.fillText("Tel | 02-3213-2132" + document.getElementById("telephone").value, 200, 220);
		context.fillText("Fax | 02-2133-2131" + document.getElementById("fax").value, 200, 240);
		context.fillText("E-mail | komorebi@komorebi.com" + document.getElementById("email").value, 200, 260);
			...
			context.font = "20px Arial";
			context.fillText("James Cloud" + document.getElementById("name").value, 50, 180);

			context.font = "15px Arial";
			context.fillText("영업부" + document.getElementById("depart").value, 50, 220);
			context.fillText("부장 " + document.getElementById("position").value, 50, 240);
			
			context.font = "20px Arial";
			context.fillText("Komorebi Co." + document.getElementById("company").value, 50, 270);
			
			context.font = "15px Arial";
			context.fillText("서울시 강남구 삼성동 코엑스 4층 101호" + document.getElementById("address").value, 300, 180);
			context.fillText("Mobile | 010-4013-1414" + document.getElementById("mobile").value, 300, 200);
			context.fillText("Tel | 02-3213-2132" + document.getElementById("telephone").value, 300, 220);
			context.fillText("Fax | 02-2133-2131" + document.getElementById("fax").value, 300, 240);
			context.fillText("E-mail | komorebi@komorebi.com" + document.getElementById("email").value, 300, 260);
		}//3번 if
			...
			context.font = "20px Arial";
			context.fillText("Komorebi Co. |" + document.getElementById("company").value, 50, 220);
			
			
			context.font = "15px Arial";
			context.fillText("서울시 강남구 삼성동 코엑스 4층 101호" + document.getElementById("address").value, 250, 220);
			context.fillText("Tel | 02-3213-2132" + document.getElementById("telephone").value, 250, 240);
			context.fillText("Fax | 02-2133-2131" + document.getElementById("fax").value, 400, 240 );
			context.fillText("E-mail  |komorebi@komorebi.com" + document.getElementById("email").value, 250, 260);
			
			
			context.font = "15px Arial";
			context.fillText("부장 " + document.getElementById("position").value, 300, 140);
			context.fillText("| 영업부" + document.getElementById("depart").value, 350, 140);
			
			context.font = "35px Arial";
			context.fillText("주 현 택" + document.getElementById("name").value, 420, 140);
			
			context.font = "20px Arial";
			context.fillText("C.P. 010-4013-1414" + document.getElementById("mobile").value, 350, 180);
			...
			context.fillText("주 현 택" + document.getElementById("name").value, 50, 80);
			
			context.font = "15px Arial";
			context.fillText("CEO" + document.getElementById("position").value, 50, 110);
			context.fillText("Administrator" + document.getElementById("depart").value, 50, 130);
			
			context.font = "20px Arial";
			context.fillText("Komorebi Co." + document.getElementById("company").value, 380, 230);
			
			
			context.font = "15px Arial";
			context.fillText("서울시 강남구 삼성동 코엑스 4층 101호" + document.getElementById("address").value, 70, 180);
			context.fillText("Mobile | 010-4013-1414" + document.getElementById("mobile").value, 70, 200);
			context.fillText("Tel | 02-3213-2132" + document.getElementById("telephone").value, 70, 220);
			context.fillText("Fax | 02-2133-2131" + document.getElementById("fax").value, 70, 240 );
			context.fillText("E-mail  | komorebi@komorebi.com" + document.getElementById("email").value, 70, 260);
		...
		<section style="background-image: url(images/cardTypeEx/sample.jpg);"
			...
			<div class="shell">
				<div class="page-title">
					<h2>Register Others Business Card</h2>
				</div>
			</div>
		</section>
...
<br><br>
								<div class="cell-sm-3">
									<div class="form-group" class="form-control" align="left">
										...
										<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
										<input type="radio" name="language" value="kor"	id="language" checked="checked" style="cursor:pointer" >
										<label for="kor" style="cursor:pointer">KOR</label>&nbsp;&nbsp;&nbsp;  
										<input type="radio" name="language" value="eng" id="language" style="cursor:pointer" >
										<label for="eng" style="cursor:pointer">ENG</label>&nbsp;&nbsp;&nbsp;
										<input type="radio" name="language" value="jap"	id="language" style="cursor:pointer">
										<label for="jap" style="cursor:pointer">JAP</label> 
									</div>
								</div>
