...
<body style="background-image: url(images/register_BG.jpg);" class="one-screen-page bg-gray-darker bg-image">
            ...
            <header class="page-head">
               ...
               <div class="page-head-inner">
                  <div class="shell text-center">
                     ...
                     <img src="images/logo-white.png" width="200" height="22" alt="logo" /></a>
                  </div>
               </div>
            </header>
                  ...
                  <div class="range range-sm-center">
                     <div class="cell-sm-7 cell-md-5 cell-lg-4">
                        <div class="block-shadow text-center">
                           ...
                           <form class="rd-mailform form-modern form-darker offset-top-20" action="register" method="POST">
                              <div class="block-inner">
                                 <div class="form-group">
                                    <input id="userid" type="text" name="m_id" data-constraints="@Required" class="form-control form-control-has-validation" placeholder="ID">
                                    <span id="idcheck" style="color:red" ></span>
                                    <label for="userid" class="form-label rd-input-label not-empty"></label>
                                 </div>
                                 <div class="form-group offset-top-22">
                                    <input id="register-form-password" type="password" name="m_password" data-constraints="@Required" class="form-control" placeholder="Password">
                                    <label for="register-form-password" class="form-label"></label>
                                 </div>
                                 <div class="form-group offset-top-22">
                                    <input id="userEmail" type="email" name="m_email" data-constraints="@Email @Required" class="form-control" placeholder="Email"> 
                                    ...
                                    <div id="test2" class="form-group ofset-top-22">
                                       ...
                                       <div class="form-group" id="test" >
                    						<input id="checknum" type="text" name="checknum" data-constraints="@Required" class="form-control" placeholder="인증번호" >
                    						<!-- <span class="form-validation"></span> -->
                    						<label class="form-label rd-input-label" for="checknum"></label>
                  						</div>
                  						<input type="button" id="checknumc" name="checknumc" value="메일인증" class="btn btn-info btn-shadow btn-xs">
                                    </div>
                                 </div>
                                 
                                 <div class="form-group offset-top-22">
                                    <input id="register-form-name" type="text" name="m_name" data-constraints="@Required" class="form-control" placeholder="Name"> <label for="register-form-name" class="form-label"></label>
                                 </div>
                              </div>
                              <div class="offset-top-30 offset-sm-top-40">
                                 <input type="hidden" id="_chk_id" name="chk_Id" value="0">
                                 <button type="submit" class="btn btn-primary btn-block" onclick="return check()">Join</button>
                              </div>
                           </form>
                        </div>
                     </div>
