...
<script type="text/javascript">
	...
	function cardView() {
		...
		context.fillText(document.getElementById("depart").value, 255, 100);

		context.fillText(document.getElementById("position").value, 299, 100);

		context.fillText("전화 | " + document.getElementById("telephone").value,
				10, 150);

		context.fillText("email | " + document.getElementById("email").value,
				110, 150);

		context.fillText("fax |" + document.getElementById("fax").value, 270,
				150);

		context.fillText("주소 | " + document.getElementById("address").value,
				10, 170);

		context.font = "40px Arial";

		context.fillText(document.getElementById("name").value, 320, 100);
	}
</script>
</head>
<body style="">
							...
							<div class="range range-7">
								...
								<div class="cell-sm-3 offset-top-20">
									<div class="form-group" align="left">
										한국어<input type="radio" id="language" name="language"
											value="kor" checked="checked"> 일본어 <input
								...
								<div class="cell-sm-3 offset-top-20">
									<div class="form-group">
										<input class="inputfile inputfile-1" type="file" id="logo"
											...
											accept="image/*"> <label for="logo"><svg
